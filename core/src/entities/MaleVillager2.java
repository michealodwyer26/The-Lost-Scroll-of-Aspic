...
public class MaleVillager2 extends Sprite {
	...
	private static Texture spriteSheet = new Texture("data/sprites/maleVillager2.png");
	...
	public MaleVillager2(RpgGame game, ArrayList<Rectangle> mapObjectsRects, Rectangle playerRect) {
		super(spriteSheet);

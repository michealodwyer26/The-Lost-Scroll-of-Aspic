...
public class FemaleVillager2 extends Sprite {
	...
	private static Texture spriteSheet = new Texture("data/sprites/femaleVillager2.png");
	...
	public FemaleVillager2(RpgGame game, ArrayList<Rectangle> mapObjectsRects, Rectangle playerRect) {
		super(spriteSheet);

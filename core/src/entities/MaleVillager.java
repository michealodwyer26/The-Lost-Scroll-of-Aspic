...
public class MaleVillager  extends Sprite {
	...
	private static Texture spriteSheet = new Texture("data/sprites/maleVillager.png");
	...
	public MaleVillager(RpgGame game, ArrayList<Rectangle> mapObjectsRects, Rectangle playerRect) {
		super(spriteSheet);
		...
		frames.add(new TextureRegion(getTexture(), 102, 32, 20, 32));
	...
	public void update(float dt) {
		...
		// Handle all the walking system
		setWalkingVariables();
		
		boolean isWalking = (walkingSouth || walkingNorth || walkingWest || walkingEast);
